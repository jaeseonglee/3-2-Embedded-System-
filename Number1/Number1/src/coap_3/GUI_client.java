...
public class GUI_client extends JFrame implements CoapClient{
	...
	public GUI_client (String serverAddress, int serverPort) {
		...
		//btn
		btn_get.setBounds(20, 550, 100, 50);
		btn_put.setBounds(130, 550, 100, 50);
		btn_post.setBounds(240, 550, 100, 50);
		btn_delete.setBounds(350, 550, 100, 50);
		btn_obsget.setBounds(460, 550, 130, 50);
		...
		payload_label.setBounds(20, 470, 350, 30);
		payload_text.setBounds(20, 500, 440, 30);
		payload_text.setFont(new Font("arian", Font.BOLD, 15));
		
		path_label.setBounds(20, 400, 350, 30);
		path_text.setBounds(20, 430, 440, 30);
		...
		display_text_jp.setBounds(20, 40, 850, 300);
	...
	public void onResponse(CoapClientChannel channel, CoapResponse response) {
		...
		if(Encoder.ByteToString(response.getToken()).equals("ObToken")) {
			automated_led(Encoder.ByteToString(response.getPayload()));
		}
	}
	
	
	public void automated_led(String t) {
		//23도 보다 높으면 빨간색, 낮으면 초록색 
		Float temp = Float.parseFloat(t);
		
		if(temp >= 23 ) {
			//red 
			if(!led_state.equals("red")) {
	...
	public static void main(String[] args){
		//프레임 열기
		GUI_client gui = new GUI_client("192.168.0.6", CoapConstants.COAP_DEFAULT_PORT);
	}
